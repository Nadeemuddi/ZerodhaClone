  ...
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted">
        <div className="col-6 fs-5 text-start p-5 lh-lg">
          <p>
        ...
        <div className="col-6 fs-5 text-start p-5 lh-lg">
          ...
          <p>
            <a className="text-decoration-none" href="">Rainmatter</a>, our fintech fund and incubator, has invested in several
