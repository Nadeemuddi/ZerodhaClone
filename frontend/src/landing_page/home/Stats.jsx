      ...
      <div className="row p-5">
        <div className="col-6 p-5">
          ...
          <p className="text-muted">
            ...
            crores worth of equity investors.
          </p>
          ...
          <p className="text-muted">
            Not just an app,but a whole ecosystem. Our investments in 30+fintch
          ...
          <p className="text-muted">
            ...
            facilitate transections, but actively help you do better with your
            money.
          </p>
        </div>
        <div className="col-6 p-5">
          ...
          <div className="text-center">
            <a className="mx-5 text-decoration-none" href="/">Explore our products<i className="fa-solid fa-arrow-right-long"></i></a>
